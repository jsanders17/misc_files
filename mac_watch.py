#!/usr/bin/python
#
# jonathan sanders - 06/23/17
# code snippets taken from joshua smith smartcenter.py script
...
# log into internet switch, get mac address table, then do a diff
print
print 'upgrade export going to ' + filename + '.tgz'
print
print '[*] logging into smartcenter'
child = pexpect.spawn ('ssh itgsecuser@10.0.195.11', timeout=30000)
